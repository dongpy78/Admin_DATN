...
import SearchSalary from "../../components/salary/SearchSalary";
import TableSalary from "../../components/salary/TableSalary";
...
export const loader = async ({ request }) => {
  ...
  try {
    const response = await axiosInstance.get(
      `/list-allcodes?type=SALARYTYPE&limit=5&offset=${offset}`
    );
...
export const action = async ({ request }) => {
  ...
  try {
    const searchQuery = searchValues.search
      ...
      : "";
    const url = `/list-allcodes?type=SALARYTYPE&limit=5&offset=${offset}${searchQuery}`;
